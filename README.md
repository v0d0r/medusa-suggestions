...
- **Streaming Providers** — See which streaming services carry each show (lazy-loaded, cached 24h)
- **"Watch on" Detection** — If a show is on your streaming services, it shows "📺 Watch on Netflix" instead of suggest
